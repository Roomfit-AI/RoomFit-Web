...
describe("SelectedFurnitureActions", () => {
  it("renders one rotate and one delete control for the selected furniture", () => {
  ...
  it("keeps rotate and delete disabled when no furniture is selected", () => {
  ...
  it("calls the existing rotate and delete handlers with the selected id", () => {
