...
const Bed: VisualComponent = (props) => (
...
const SofaBed: VisualComponent = (props) => (
...
const Sofa: VisualComponent = (props) => (
...
const Nightstand: VisualComponent = (props) => (
...
const SideTable: VisualComponent = (props) => (
...
const Table: VisualComponent = (props) => (
...
const Desk: VisualComponent = (props) => (
...
const Chair: VisualComponent = (props) => (
...
const Bookshelf: VisualComponent = (props) => (
...
const Hanger: VisualComponent = (props) => (
...
const Partition: VisualComponent = (props) => (
...
const Wardrobe: VisualComponent = (props) => (
...
const Drawer: VisualComponent = (props) => (
...
const TvStand: VisualComponent = (props) => (
...
const Monitor: VisualComponent = (props) => (
...
const Tv: VisualComponent = (props) => (
...
const Lamp: VisualComponent = (props) => (
...
const Rug: VisualComponent = (props) => (
...
const Plant: VisualComponent = (props) => (
...
const Mirror: VisualComponent = (props) => (
...
const Curtain: VisualComponent = (props) => (
